...
base = (
    os.environ["unetr_pp_raw_data_base"]
    if "unetr_pp_raw_data_base" in os.environ.keys()
    else None
)
preprocessing_output_dir = (
    os.environ["unetr_pp_preprocessed"]
    if "unetr_pp_preprocessed" in os.environ.keys()
    else None
)
...
if base is not None:
    ...
    print(
        "unetr_pp_raw_data_base is not defined and model can only be used on data for which preprocessed files "
...
if preprocessing_output_dir is not None:
    ...
    print(
        "unetr_pp_preprocessed is not defined and model can not be used for preprocessing "
