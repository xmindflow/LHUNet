...
from lhunet.training.dataloading.dataset_loading import (
    load_dataset,
    DataLoader3D,
    DataLoader2D,
    unpack_dataset,
)
from lhunet.training.loss_functions.dice_loss import DC_and_CE_loss
from lhunet.training.network_training.network_trainer_acdc import NetworkTrainer_acdc
...
class Trainer_acdc(NetworkTrainer_acdc):
    ...
    def preprocess_patient(self, input_files):
        ...
        assert preprocessor_class is not None, (
            "Could not find preprocessor %s in lhunet.preprocessing"
            % preprocessor_name
        )
    ...
    def validate(
        ...
        if run_postprocessing_on_folds:
            # in the old lhunet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
