...
def process_label(label):
    ...
    et = np.isin(label, [3])
    tc = np.isin(label, [2, 3])
    return tuple([wt, et, tc])
...
def test(fold):
    path_validation = f"/hdd/LHUNET_NEW_CHECKPOINTS/V2/BratsDecathelon/lhunet_v22_lr_0.01_rb_t_r_t_amp_dr0_GPU2_dec7 (copy)/Dataset703_BraTSDecathelon/lhunetBratsTrainer__nnUNetPlans__3d_fullres/"
    path_gt="/hdd/nnunet_dataset/nnunet_raw/Dataset703_BraTSDecathelon/labelsTr/"
